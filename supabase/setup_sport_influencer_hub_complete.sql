-- ============================================================================
-- SPORT INFLUENCER HUB — COMPLETE DATABASE SCHEMA SETUP
-- Tables: kols, communities, sport_projects, kol_reports, scout_requests,
--         scouted_posts, kol_metric_snapshots
-- Run this SQL in your Supabase Dashboard SQL Editor:
-- https://supabase.com/dashboard/project/xfqwxehetbjofoaygeqj/sql/new
-- ============================================================================
...
create table if not exists public.kols (
  ...
  pending_scout_diff  jsonb default null,
  last_scouted_at     timestamptz default null,
...
-- ---------------------------------------------------------------------------
-- 2. kol_metric_snapshots (Lịch sử tăng trưởng metrics theo thời gian)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 3. communities (Hội nhóm, Câu lạc bộ & Diễn đàn thể thao)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 4. sport_projects (Chiến dịch Booking & Dự án thể thao)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 5. kol_reports (Form Đánh giá & Nghiệm thu sau chiến dịch)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 6. scout_requests (Hàng đợi yêu cầu cào Meta / TikTok / Threads)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 7. scouted_posts (Kho bài viết & Reels viral đã scout)
-- ---------------------------------------------------------------------------
